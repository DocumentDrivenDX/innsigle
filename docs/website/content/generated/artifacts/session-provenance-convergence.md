---
title: "Session provenance — convergence (Claude + Codex adversarial review)"
slug: session-provenance-CONVERGENCE
activity: "Design"
source: "02-design/session-provenance-CONVERGENCE.md"
generated: true
supporting: false
---

> **Generated from HELIX docs.** Source: `docs/helix/02-design/session-provenance-CONVERGENCE.md`. Edit the source, not this file or `site/` HTML.
